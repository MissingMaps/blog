...
- Practical sessions which included going into the community and linking drawings to the satellite images by first starting with field papers by tagging with [OMK](www.openmapkit.org)
- Exposure and tutorials on various open source applications (websites) and design and used for apps ([ODK](https://opendatakit.org/), [OMK](www.openmapkit.org), [OsmAnd](http://osmand.net/), [POSM](www.posm.io)).
